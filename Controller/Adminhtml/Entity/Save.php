...
use Wisepet\ScopedEav\Controller\Adminhtml\AbstractEntity;

class Save extends \Wisepet\ScopedEav\Controller\Adminhtml\AbstractEntity
{
    /**
     ...
     *
     * @param \Wisepet\ScopedEav\Api\Data\EntityInterface $entity Current entity.
     * @param array                                     $data   Data.
     *
     * @return array
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    private function imagePreprocessing(\Wisepet\ScopedEav\Api\Data\EntityInterface $entity, $data)
    {
        ...
        foreach ($entityType->getAttributeCollection() as $attributeModel) {
            ...
            if (isset($data['entity'][$attributeCode]) || !$backendModel instanceof \Wisepet\ScopedEav\Model\Entity\Attribute\Backend\Image) {
                continue;
            }
